        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="p-2 bg-white/10 rounded-full hover:bg-blue-600 transition-colors"><MdFacebook size={18} /></a>
              <a href="#" className="p-2 bg-white/10 rounded-full hover:bg-blue-400 transition-colors"><FaTwitter size={18} /></a>
              <a href="#" className="p-2 bg-white/10 rounded-full hover:bg-pink-600 transition-colors"><FaInstagram size={18} /></a>
              <a href="#" className="p-2 bg-white/10 rounded-full hover:bg-blue-700 transition-colors"><FaLinkedin size={18} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link href="/apparel" className="hover:text-blue-400 transition">Apparel</Link></li>
              <li><Link href="/accessories" className="hover:text-blue-400 transition">Accessories</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link href="/return" className="hover:text-blue-400 transition">Return Policy</Link></li>
